...
谢镇涛，19级计算机科学与技术，考研上岸华东师范大学计算机系专硕

**择校**

​	考研报考学校，可以说是玄学。很多人择校的时候喜欢搁那博弈，动辄三层四层博弈的，其实大家都在第一层，大多数学校（除了热门的学校，比如软微、科软）基本上一年炸一年稍微爆冷。不要一上来就认死了报考某个学校（当然如果你非常喜欢某个学校，当我没说过），现在大多数计算机考研都是考408，老老实实把那4本书学过去。等到快要报考前，确定学校就可以了。就以我为例，其实我一开始想着就是厦大或者福大，但后面厦大大规模缩招之后，怂了报名刚开始我报了福大。但经过一起考研的兄弟（这里点名感谢陈君延和钟日深）的怂恿，就选择当时看起来比较好考的华东师大。但后面事实上，并不好考。

**初试**

- 数学：最重要就是刷题了，想要数学能够拿高分，必须每天保持一定的题量。然后就是根据每个人不同的数学基础能力,可以选择不同的老师。如果你的基础比较好，可以看**张宇老师**的课，他的题比较难，比较新颖，能够比较有效提高你的思维能力。如果基础欠佳，可以选择看**武忠祥老师**，他的课会把题目的解法给你一一归纳，作为基础来看非常好，能够建立起比较完善的知识体系。最后就是如果你觉得你信息收集能力不错，你可以尝试一个专题看一个老师，比如中值定理看汤家凤，数列极限张宇，积分武忠祥这样，线代强化看永乐大帝。23届考研数学难度较为简单，基本来说没有一道通俗意义上的难题，主要考察就是学生的计算能力以及解题速度，而计算能力只有不停的练习才能练就。我这个人不是那种特别聪明的人，因此我考研期间刷了880+660+严选题+1800的基础和入门部分+330+108+60套各类市面上的模拟题，也就是这些题让我上考场的时候有了非常大的底气。
- 英语：英语没啥好说的，就是每天背背单词，暑假之前可以开始做做阅读，刚开始要精读精做每一篇阅读，随着你精读阅读的文章越多加上单词储备量逐渐提高，你会发现你的正确率会有巨大的提升。后期，作文无脑跟**石雷鹏**，不用太早去背作文，没啥用，最后2个月跟着石雷鹏练几篇作文，练几句功能句，作文这一块就能考得很不错了。
- 政治：**暑假开始**即可，肖1000有空就做，没空等12月背肖四肖八就行了。
- 408：无脑跟**王道**就好了，暑假前尽量把4本书过一遍，看不下去就把王道4门课看一遍，不用一定要跟当年的，往年的视频差不大多，可以直接看视频，注意此时只要做选择题即可。暑假的时候，大多数人就进入二轮复习，进入二轮复习可以选择看王道的强化课（争议蛮大，23届的质量很差，但是22届的强化课质量很高），此时要二刷选择题以及一刷所有的大题。暑假结束之后，速度快的可以开始第三轮复习，408的复习就是非常的繁琐，由于有4本专业课的书，往往看完一本丢一本，非常没有效率，只能通过自己搭建知识体系同时循环反复的看4本书直到考前才能考得一个理想的成绩。在套卷练习方面，只建议做真题就够了，刷两遍真题远比刷一些乱七八糟的模拟题（王道、天勤等等）。

**复试**

​	不大建议代码能力较弱的报考华东师大的，因为现在恢复线下复试之后，初复试比例55开，机试又占了复试40%，如果你的代码能力不行，大概率复试就没了，给一个真实案例（我复试那一场，第一个兄弟初试398，机试80/200，直接被刷掉了。由于复试没有固定的科目，因此需要准备的东西包括并且不局限于（计算机组成原理、计算机网络、操作系统、数据结构、计算机图形学、深度学习、机器学习、JAVA、并行程序设计、编译原理等等）。面试过程一定不能怂，问啥答啥，不要弄虚作假，把你自己最自信的一面展示给面试老师即可。但如果你是acm佬或者代码能力稍微还可以，又或者奖项和项目都有的佬，不嫌弃可以来试试看华东师大计算机哈。

**备注**

> 如果有想法考华东师大的学弟学妹们，可以来取取经哈！QQ：2279072142
...
陈君延，19级计算机科学与技术，考研上岸东南大学

1.**个人情况**

​	2023考研，数学：81分，英语：70分，政治：56分，专业课：935 97分，总分304，上岸东南大学 苏州联合研究生院 电子信息专业 02人工智能方向

2.**择校**

​	**东南大学**：本部位于南京，在苏州、无锡都有校区。2023年软科排名15名，算是中上游985了，综合排名比厦大高。工科强校，计算机排名15-20名这样，B+或者A-。在我心中是很好的学校了。

​	**苏州联合研究生院**：并不是独立学院。比如农大的金山学院，是独立学院。这个苏州联合研究生院，就是二级学院。苏州联合研究生院和东南大学的关系，就相当于计信院与农大。
培养模式：东南大学与澳大利亚蒙纳什大学联合培养，你的导师一般来说就是计算机学院的导师。
毕业证：东南大学硕士毕业证、东南大学计算机学位证、蒙纳什大学计算机学位证。大概是这个意思，反正985毕业证到手。
其他信息我列举一下，很有兴趣的可以回头咨询我：

> 1. 学费目前6.2wRMB一学年
> 2. 不接受跨考
> 3. 三年制
> 4. 研一上学期东南大学的课，下学期澳方的课，全英文教学（课程比较多）
> 5. 历年初试分数线总分300，英语必须60以上
> 6. 23年缩招，0102方向招35人，以往招50人
> 7. 考研复试面试全英文
> 8. 第一年在苏州，第二第三年根据情况去南京或者留苏州或者去实习
> 9. 如果去南京，没有宿舍，要自己租房。苏州有宿舍
> 10. 认可度别问，985证没问题，剩下找工作看你个人能力

个人报考原因：

> 1. 目标要去长三角工作
> 2. 要进私企，外企，不考编制，所以想尽可能去好的高校
> 3. 家里人觉得学费没问题
> 4. 往年分数线比较低，感觉自己怎么样应该都能考上

​	想报考的同学提个醒，没那么好考，英语60分的线，刷掉了总分排名在我前面的至少20多个人，复试是全英文，口语不好的话可能会比较麻烦。
​	考研300分慎重，我考研304分，复试成绩笔试面试都120+，逆袭了18个人，被录取。也是今年被录取的人里面，初试最低分。
​	有疑问可以发邮件给我，随缘回复：jeromechen015@gmail.com

3.**择校建议**

- 能保研绝不考研，考研就是赌狗
  - 每年参加考研的人，只有不到一半是一战
  - 将近500w人参加考试，考上的200w不到
  - 考研期间遇到什么样的破事你都难以预料（比如考试阳了发烧39°去考数学的）

- 如果你想以后考编，那只要是研究生都行，没必要追求985、211，没有区别，稳稳上岸不香吗

- 择校是信息战，爆冷爆炸都有可能，但是大家一般都在第一层，可以考虑今年爆炸的学校哈哈哈哈哈，今年爆冷的最好别碰，个人建议

- 第一年改考专业课的学校，一般会比较低一些（也有例外）

- 自命题不一定今年出什么样子，能不能找到真题很重要
